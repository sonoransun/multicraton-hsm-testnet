...
pub struct HsmCore {
    ...
    #[cfg(feature = "observability")]
    pub(crate) metrics: Arc<HsmMetrics>,
...
impl HsmCore {
    ...
    pub fn try_new(config: &HsmConfig) -> Result<Self, crate::error::HsmError> {
        ...
        #[cfg(feature = "observability")]
        let metrics =
            Arc::new(HsmMetrics::new().map_err(|_| crate::error::HsmError::GeneralError)?);
    ...
    /// Returns a reference to the metrics instance for observability.
    #[cfg(feature = "observability")]
